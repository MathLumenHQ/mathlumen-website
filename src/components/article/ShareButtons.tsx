...
/**
 * Share buttons for article footer: Twitter/X, LinkedIn, Copy Link.
 */
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <a
        ...
        className="p-2 text-muted hover:text-paper border border-gold/[0.18] hover:border-gold/30 transition-colors duration-200"
